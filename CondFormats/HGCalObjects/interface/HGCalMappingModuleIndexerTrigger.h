...
public:
  HGCalMappingModuleIndexerTrigger() : modFedIndexer_({maxECONTperFED_}) {}
  ...
  std::vector<HGCalTriggerFEDReadoutSequence> const &getFEDReadoutSequences() const { return fedReadoutSequences_; }
  std::vector<uint32_t> const &getGlobalTypesCounter() const { return globalTypesCounter_; }
  std::vector<uint32_t> const &getGlobalTypesNTrLinks() const { return globalTypesNTrLinks_; }
  std::vector<uint32_t> const &getGlobalTypesNTCs() const { return globalTypesNTCs_; }
  std::vector<uint32_t> const &getModuleOffsets() const { return offsetsModule_; }
  std::vector<uint32_t> const &getTrLinkOffsets() const { return offsetsTrLink_; }

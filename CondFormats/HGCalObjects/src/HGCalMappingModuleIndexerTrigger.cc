...
void HGCalMappingModuleIndexerTrigger::processNewModule(uint32_t fedid,
  ...
  if (!typecode.empty()) {
    ...
    LogDebug("HGCalMappingModuleIndexerTrigger")
        << "HGCalMappingModuleIndexerTrigger::processNewModule: Adding typecode=\"" << typecode << "\" with fedid=" << fedid
...
void HGCalMappingModuleIndexerTrigger::finalize() {
  ...
  maxTrLinksIdx_ = std::inner_product(globalTypesCounter_.begin(), globalTypesCounter_.end(), globalTypesNTrLinks_.begin(), 0);
  maxNTCIdx_ =
      std::inner_product(globalTypesCounter_.begin(), globalTypesCounter_.end(), globalTypesNTCs_.begin(), 0);
...
//
std::pair<uint32_t, uint32_t> HGCalMappingModuleIndexerTrigger::getIndexForFedAndModule(std::string const& typecode) const {
